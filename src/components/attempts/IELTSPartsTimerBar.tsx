...
export function IELTSPartsTimerBar({
  ...
  return (
    <div className="fixed top-4 right-4 z-50 flex items-stretch gap-0 rounded-xl overflow-hidden bg-white border border-gray-200/90 shadow-lg shadow-gray-200/50">
      {/* Parts */}
