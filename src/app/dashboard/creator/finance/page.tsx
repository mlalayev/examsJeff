  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-8 sm:mb-12">
        <h1 className="text-xl sm:text-2xl font-medium text-gray-900">Finance</h1>
        <p className="text-gray-500 mt-1 text-sm sm:text-base">Financial overview and analytics</p>
      </div>
      ...
      <div className="flex items-center gap-1 mb-6">
          ...
          className={`px-4 py-2 text-sm font-medium rounded-md ${
              ...
              style={activeTab === "overview" ? { backgroundColor: "#303380" } : {}}
              onMouseEnter={(e) => {
          ...
          className={`px-4 py-2 text-sm font-medium rounded-md ${
              ...
              style={activeTab === "monthly" ? { backgroundColor: "#303380" } : {}}
              onMouseEnter={(e) => {
          ...
          className={`px-4 py-2 text-sm font-medium rounded-md ${
              ...
              style={activeTab === "branches" ? { backgroundColor: "#303380" } : {}}
              onMouseEnter={(e) => {
          ...
          className={`px-4 py-2 text-sm font-medium rounded-md ${
              ...
              style={activeTab === "courses" ? { backgroundColor: "#303380" } : {}}
              onMouseEnter={(e) => {
